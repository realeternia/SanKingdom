...
{
config.Clear();
config[1] = new HeroAttrConfig(1, "str", "武力", "", "95:#FF0000,90:#FFFF00,0:#FFFFFF", "", false);
config[2] = new HeroAttrConfig(2, "inte", "智力", "", "95:#FF0000,90:#FFFF00,0:#FFFFFF", "", false);
config[3] = new HeroAttrConfig(3, "fair", "内政", "", "95:#FF0000,90:#FFFF00,0:#FFFFFF", "", false);
config[4] = new HeroAttrConfig(4, "charm", "魅力", "", "95:#FF0000,90:#FFFF00,0:#FFFFFF", "", false);
config[5] = new HeroAttrConfig(5, "leadShip", "统帅", "", "95:#FF0000,90:#FFFF00,0:#FFFFFF", "", false);
