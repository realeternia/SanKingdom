...
namespace CommonConfig
{
    public class SeasonConfig
    {
        ...
        public SeasonConfig(int Id, string Name, string Season, float AddGold, float AddFood, string BGM)
        {
            this.Id = Id;
            this.Name = Name;
            this.Season = Season;
