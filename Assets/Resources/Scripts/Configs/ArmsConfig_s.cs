...
namespace CommonConfig
{
    public class ArmsConfig
    {
        ...
        {
            config.Clear();
            config[1] = new ArmsConfig(1, "dyb", "动员兵", ArmsType.SodSword, 0, 0, 0, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodStick", 1f, 4, 0, 0, 0, 0, true, 1, false, 10);
            ...
            config[109] = new ArmsConfig(109, "elephant", "象兵", ArmsType.SodElephant, 1, 40, 20, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodElephantSpear", 1f, 20, 99, 0, 0, 0, true, 1, false, 8);
            ...
            config[601] = new ArmsConfig(601, "dao", "刀", ArmsType.SodSword, 1, 10, 8, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodDao", 1f, 4, 0, 1, 0, 0, true, 2, false, 11);
            config[602] = new ArmsConfig(602, "daoqiang", "枪", ArmsType.SodSpear, 1, 20, 10, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodSpear", 1f, 4, 0, 1, 1, 0, true, 1, false, 12);
            config[603] = new ArmsConfig(603, "daoji", "戟", ArmsType.SodHalberd, 1, 10, 20, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodHalberd", 1f, 4, 0, 1, 1, 0, true, 1, false, 10);
            config[604] = new ArmsConfig(604, "teng", "藤甲", ArmsType.SodSword, 1, 0, 40, 10, 1, 0, 0f, "SwordHitYellowCritical", "SodTeng", 1f, 4, 0, 0, 0, 99, true, 1, false, 7);
            config[901] = new ArmsConfig(901, "jianta", "箭塔", ArmsType.SodBow, 1, 0, 0, 0, 3, 60, 10f, "BulletExplosionBlue", "SodBow", 1f, 4, 0, 0, 1, 0, false, 1, false, 1);
