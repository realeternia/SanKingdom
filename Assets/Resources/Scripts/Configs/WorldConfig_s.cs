...
namespace CommonConfig
{
    public class WorldConfig
    {
        ...
        public WorldConfig(int Id, string Name, string Cname, int X, int Y, int Width, int Height, int ForceId, int Level, int Food, int Soldier, int Wall, int[] WorldNearIds, int[] MiniMapOffsets, string ViewPrefab)
        {
            this.Id = Id;
            this.Name = Name;
            this.Cname = Cname;
        ...
        public static void Load()
        {
            ...
            config[10020] = new WorldConfig(10020, "luoyang", "洛阳", 704, 613, 328, 283, 5, 7, 100, 100, 100, new int[]{10005,10018,10019,10021,10002,10004}, new int[]{5,0}, "changan");
            config[10021] = new WorldConfig(10021, "changan", "长安", 370, 575, 415, 351, 5, 6, 100, 100, 100, new int[]{10037,10018,10020,10022,10036,10005}, new int[]{10,-15}, "changan");
            config[10022] = new WorldConfig(10022, "anding", "安定", 155, 412, 411, 335, 5, 1, 100, 100, 100, new int[]{10024,10021,10023}, new int[]{0,-10}, "xiliang");
            config[10023] = new WorldConfig(10023, "tianshui", "天水", 42, 623, 322, 253, 6, 1, 100, 100, 100, new int[]{10037,10022,10024}, new int[]{-15,0}, "xiliang");
            config[10024] = new WorldConfig(10024, "wuwei", "武威", 42, 253, 288, 386, 6, 1, 100, 100, 100, new int[]{10023,10022}, new int[]{-10,0}, "xiliang");
            config[10025] = new WorldConfig(10025, "wulin", "武陵", 630, 1442, 351, 266, 7, 1, 100, 100, 100, new int[]{10026,10030,10027,10031,10015}, new int[]{0,-10}, "changsha");
            config[10026] = new WorldConfig(10026, "lingling", "零陵", 641, 1684, 314, 358, 7, 1, 100, 100, 100, new int[]{10025,10009}, new int[]{-24,0}, "changsha");
            config[10027] = new WorldConfig(10027, "jiangling", "江陵", 669, 1254, 438, 243, 7, 3, 100, 100, 100, new int[]{10030,10025,10028,10029,10014,10015}, new int[]{15,0}, "chengdu");
            config[10028] = new WorldConfig(10028, "xiangyang", "襄阳", 640, 1080, 305, 241, 7, 5, 100, 100, 100, new int[]{10030,10027,10001,10036,10005,10029}, new int[]{-5,0}, "jianye");
            config[10029] = new WorldConfig(10029, "jiangxia", "江夏", 949, 1115, 377, 215, 7, 3, 100, 100, 100, new int[]{10027,10028,10039,10010,10014,10001,10038}, new int[]{0,-7}, "xinye");
            config[10030] = new WorldConfig(10030, "yongan", "永安", 425, 1106, 311, 382, 8, 1, 100, 100, 100, new int[]{10025,10027,10031,10035,10028,10036}, new int[]{0,-15}, "changsha");
            config[10031] = new WorldConfig(10031, "jiangzhou", "江州", 269, 1295, 355, 344, 8, 2, 100, 100, 100, new int[]{10030,10032,10033,10025}, new int[]{5,-15}, "xinye");
