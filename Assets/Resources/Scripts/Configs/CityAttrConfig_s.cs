...
namespace CommonConfig
{
    public class CityAttrConfig
    {
        ...
        public static void Load()
        {
            ...
            config[11] = new CityAttrConfig(11, "gold", "金钱", true, false, true, false, 0, 999, "citygold", "势力金钱，用于委派和交易\\\\n通过市场/金矿/盐矿/渔场委派产出\\\\n委派需要消耗金钱\\\\n快乐度影响产出倍率");
            config[12] = new CityAttrConfig(12, "scipoint", "研究值", true, false, true, false, 0, 999, "cityscip", "势力研究值，通过研究院委派产出\\\\n用于科技研究消耗\\\\n每次研究消耗固定研究值");
            ...
            config[17] = new CityAttrConfig(17, "elephant", "战象", true, true, false, true, 0, 99, "cityelephant", "势力战象资源，用于象兵兵种建造\\\\n通过象棚委派产出\\\\n占有特殊城市可获得额外加成");
