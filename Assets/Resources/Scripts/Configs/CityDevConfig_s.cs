...
config[21102] = new CityDevConfig(21102, "移动", "移动到其他城市", "king", true, "CityDevMove", "move", 0, 10, "", new float[0], "", new float[0], "", new int[0], new string[]{"LeadShip","Charm"}, "", 28, 4, 9, "move2.mp4");
config[21103] = new CityDevConfig(21103, "出战", "出兵攻打敌人", "king", true, "CityDevBattle", "battle", 0, 10, "", new float[0], "", new float[0], "", new int[0], new string[]{"LeadShip","Str"}, "", 0, 1, 0, "atk2.mp4");
...
config[21401] = new CityDevConfig(21401, "登用", "提拔在野武将", "king", true, "CityDevUseHero", "wild", 0, 1, "", new float[0], "", new float[0], "", new int[0], new string[]{"Charm","Inte"}, "", 2, 0, 0, "wild.mp4");
config[21402] = new CityDevConfig(21402, "褒奖", "提升武将忠心度", "king", true, "CityDevPraiseHero", "praise", 10, 5, "", new float[0], "", new float[0], "praise", new int[]{1,5}, new string[]{"Charm","Inte"}, "", 3, 12, 0, "wild.mp4");
