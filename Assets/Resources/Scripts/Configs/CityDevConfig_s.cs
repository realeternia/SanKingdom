...
namespace CommonConfig
{
    public class CityDevConfig
    {
        ...
        public static void Load()
        {
            ...
            config[21203] = new CityDevConfig(21203, "交易", "买粮食和士兵", "run", false, true, "Trade", "change", 10, 0, "", new float[0], "", new float[0], new string[]{"Inte"}, "", 0f, 0f, 0f);
            config[21204] = new CityDevConfig(21204, "登用", "提拔在野武将", "run", false, true, "UseHero", "wild", 0, 5, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21205] = new CityDevConfig(21205, "褒奖", "提升武将忠心度", "run", false, true, "Praise", "praise", 0, 5, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21206] = new CityDevConfig(21206, "奖赏", "提升武将忠心度", "run", false, true, "Praise", "praise", 10, 0, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21207] = new CityDevConfig(21207, "破坏", "破坏敌人城防", "run", false, true, "EnemyCity", "destroy", 10, 0, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21208] = new CityDevConfig(21208, "扰乱", "扰乱敌人民心和忠诚度", "run", false, true, "EnemyCity", "destroy", 15, 0, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21209] = new CityDevConfig(21209, "外交", "亲善目标势力", "run", false, true, "Relation", "peace", 30, 0, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
            config[21210] = new CityDevConfig(21210, "挑拨", "降低两个目标势力间的友好度", "run", false, true, "Relation", "peace", 20, 0, "", new float[0], "", new float[0], new string[]{"Charm","Inte"}, "", 0f, 0f, 0f);
