...
namespace CommonConfig
{
    public class CityDevConfig
    {
        ...
        public CityDevConfig(int Id, string Cname, string Des, string Type, string Prefab, string Icon, int GoldCost, int HeroCount, string DevAttr1, float[] DevAttr1Value, string DevAttr2, float[] DevAttr2Value, string SpecialAction, int[] SpecialActionVal, string[] Attrs, string ActionName, int AiPriotyDev, int AiPriotyAtk, int AiPriotyDef, string Mp4)
        {
            this.Id = Id;
            this.Cname = Cname;
            this.Des = Des;
        ...
        {
            config.Clear();
            config[21001] = new CityDevConfig(21001, "农田", "提升粮食产量", "normal", "CityDevNormal", "farm", 0, 1, "food", new float[]{3f,2.7f,2.3f,2f}, "exp", new float[]{1f,0.8f,0.6f,0.5f}, "", null, new string[]{"Fair","Str"}, "dev", 11, 0, 0, "farm.mp4");
            config[21002] = new CityDevConfig(21002, "市场", "提升金钱收入", "normal", "CityDevNormal", "market", 0, 1, "gold", new float[]{3f,2.7f,2.3f,2f}, "exp", new float[]{1f,0.8f,0.6f,0.5f}, "", null, new string[]{"Fair","Inte"}, "dev", 10, 0, 0, "shop3.mp4");
            config[21003] = new CityDevConfig(21003, "征兵", "提升士兵数量", "normal", "CityDevNormal", "zhengbing", 10, 1, "soldier", new float[]{3f,2.7f,2.3f,2f}, "exp", new float[]{1f,0.8f,0.6f,0.5f}, "", null, new string[]{"LeadShip","Charm"}, "sod", 0, 8, 2, "zhengbing2.mp4");
            config[21004] = new CityDevConfig(21004, "加固城墙", "提升城防", "normal", "CityDevNormal", "wall", 10, 1, "wall", new float[]{3f,2.7f,2.3f,2f}, "exp", new float[]{1f,0.8f,0.6f,0.5f}, "", null, new string[]{"Str"}, "def", 30, 0, 10, "fix4.mp4");
            config[21005] = new CityDevConfig(21005, "训练", "提升军队士气", "normal", "CityDevNormal", "train", 0, 1, "happy", new float[]{3f,2.7f,2.3f,2f}, "", null, "", null, new string[]{"LeadShip","Str"}, "sod", 0, 9, 3, "train3.mp4");
            ...
            config[21202] = new CityDevConfig(21202, "走访", "搜集人才和宝物", "normal", "CityDevNormal", "find", 0, 1, "gold", new float[]{1f,0.8f,0.6f,0.5f}, "", null, "", null, new string[]{"Charm","Inte"}, "find", 21, 0, 11, "search2.mp4");
            ...
            config[21403] = new CityDevConfig(21403, "采石场", "提升石料", "normal", "", "stone", 0, 1, "stone", new float[]{3f,2.7f,2.3f,2f}, "", null, "", null, new string[]{"Charm","Inte"}, "", 0, 0, 0, "wild.mp4");
            config[21404] = new CityDevConfig(21404, "马场", "提升马场", "normal", "", "horse", 0, 1, "horse", new float[]{3f,2.7f,2.3f,2f}, "", null, "", null, new string[]{"Charm","Inte"}, "", 0, 0, 0, "wild.mp4");
            config[21405] = new CityDevConfig(21405, "木材场", "提升木材", "normal", "", "wood", 0, 1, "wood", new float[]{3f,2.7f,2.3f,2f}, "", null, "", null, new string[]{"Charm","Inte"}, "", 0, 0, 0, "wild.mp4");
            config[21406] = new CityDevConfig(21406, "铁匠铺", "提升铁", "normal", "", "steel", 0, 1, "steel", new float[]{3f,2.7f,2.3f,2f}, "", null, "", null, new string[]{"Charm","Inte"}, "", 0, 0, 0, "wild.mp4");
