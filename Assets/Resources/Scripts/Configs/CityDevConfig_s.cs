...
namespace CommonConfig
{
    public class CityDevConfig
    {
        ...
        {
            config.Clear();
            config[21001] = new CityDevConfig(21001, "发展农业", "发展农业,提升粮食产量", "CityDevNormal", "farm", 300, 3, "ArchFood", new int[]{4,10}, "ArchPeople", new int[]{300,800}, "", null, new string[]{"Fair","Str"}, "dev", 11, 0, 0, "farm.mp4");
            config[21002] = new CityDevConfig(21002, "发展商业", "发展商业,提升金钱收入", "CityDevNormal", "market", 300, 3, "ArchGold", new int[]{4,10}, "ArchPeople", new int[]{300,800}, "", null, new string[]{"Fair","Inte"}, "dev", 10, 0, 0, "shop3.mp4");
            config[21101] = new CityDevConfig(21101, "加固城墙", "提升城防", "CityDevNormal", "wall", 200, 3, "Wall", new int[]{6,15}, "Secure", new int[]{1,3}, "", null, new string[]{"Str"}, "def", 30, 0, 10, "fix4.mp4");
            ...
            config[21202] = new CityDevConfig(21202, "走访", "搜集人才和宝物", "CityDevNormal", "find", 0, 10, "Gold", new int[]{20,100}, "", null, "", null, new string[]{"Charm","Inte"}, "find", 21, 0, 11, "search2.mp4");
            ...
            config[21302] = new CityDevConfig(21302, "征兵", "提升士兵数量", "CityDevNormal", "zhengbing", 300, 3, "Soldier", new int[]{200,600}, "Secure", new int[]{-2,-5}, "ArchPeople", new int[]{-500,-1500}, new string[]{"LeadShip","Charm"}, "sod", 0, 8, 2, "zhengbing2.mp4");
