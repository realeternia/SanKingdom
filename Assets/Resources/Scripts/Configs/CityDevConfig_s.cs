...
namespace CommonConfig
{
    public class CityDevConfig
    {
        ...
        public static void Load()
        {
            ...
            config[21005] = new CityDevConfig(21005, "market", "走访", "搜集人才和宝物", "CityDevNormal", false, "find", 0, 10, "Gold", new int[]{20,100}, "", null, "", null, new string[]{"Charm","Inte"}, "find", "search2.mp4");
            config[21006] = new CityDevConfig(21006, "army", "训练", "提升军队士气", "CityDevNormal", false, "train", 0, 3, "Power", new int[]{3,9}, "", null, "", null, new string[]{"LeadShip","Str"}, "sod", "train3.mp4");
            config[21007] = new CityDevConfig(21007, "army", "征兵", "提升士兵数量", "CityDevNormal", false, "zhengbing", 300, 3, "Soldier", new int[]{200,600}, "Secure", new int[]{-2,-5}, "ArchPeople", new int[]{-500,-1500}, new string[]{"LeadShip","Charm"}, "sod", "zhengbing2.mp4");
