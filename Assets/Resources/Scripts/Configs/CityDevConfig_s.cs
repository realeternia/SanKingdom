...
namespace CommonConfig
{
    public class CityDevConfig
    {
        ...
        public static void Load()
        {
            ...
            config[21205] = new CityDevConfig(21205, "褒奖", "提升武将忠心度", "run", false, true, "Praise", "praise", 0, 5, "", new float[0], "", new float[0], null, "", 0f, 0f, 0f);
            config[21206] = new CityDevConfig(21206, "奖赏", "提升武将忠心度", "run", false, true, "Praise", "praise", 10, 0, "", new float[0], "", new float[0], null, "", 0f, 0f, 0f);
            config[21207] = new CityDevConfig(21207, "破坏", "破坏敌人城防", "run", false, true, "EnemyCity", "destroy", 10, 0, "", new float[0], "", new float[0], new string[]{"Str","Inte"}, "", 0f, 0f, 0f);
