...
namespace CommonConfig
{
    public class SkillConfig
    {
        ...
        public static void Load()
        {
            ...
            config[203009] = new SkillConfig(203009, "分兵", "分", "被攻击时产生一只有伤害部队", "", 1, 0.4f, 15f, 0, 0, "leadShip", null, 15f, false, "", 0, 0, 0, 0.5f, 0.5f, 0, 4, 0, 0, "", "", 0, false, 0, "", 0, 0, 0, 0, 0, "AttackedShadow", "sway", "MagicFieldGreen", "", "MagicFieldGreen", 0, 3, "fen2");
            config[203010] = new SkillConfig(203010, "分兵小", "纷", "被攻击时产生一只无伤害部队", "", 1, 0.4f, 15f, 0, 0, "leadShip", null, 15f, false, "", 0, 0, 0, 0.4f, 0.01f, 0, 4, 0, 0, "", "", 0, false, 0, "", 0, 0, 0, 0, 0, "AttackedShadow", "sway", "MagicFieldGreen", "", "MagicFieldGreen", 0, 2, "fen3");
