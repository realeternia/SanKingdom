...
namespace CommonConfig
{
    public class BattleSkillConfig
    {
        ...
        {
            config.Clear();
            config[200001] = new BattleSkillConfig(200001, "王", "帅", "给与我方同阵营单位17%生命值护盾", "职业", 1, 0f, 0, 0f, "", null, 0f, false, "", 0, 0f, 0, 0.17f, 0f, 0f, 0, 0, "", "", 300001, false, 999, "", 0, 0f, 0, 0f, 0f, "InitMasterShield", "", "", "", "", 0f, "shuai");
            config[200002] = new BattleSkillConfig(200002, "羽扇", "扇", "击中目标时触发弹射", "职业", 1, 0f, 0, 0f, "inte", null, 30f, false, "", 1, 0f, 0, 0f, 0.15f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackReboundArrow", "sway", "", "", "", 0f, "shan");
            ...
            config[200005] = new BattleSkillConfig(200005, "突破", "马", "移动时穿越敌人,造成额外伤害", "职业", 1, 1f, 7, 0f, "leadShip", null, 0f, false, "", 0, 0f, 0, 0f, 0.5f, 0f, 0, 0, "", "", 301003, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackRunCross", "", "", "", "LightningExplosionBlue", 0f, "ma");
            config[200006] = new BattleSkillConfig(200006, "运筹", "相", "提升士兵等级", "职业", 1, 0f, 0, 0f, "inte", null, 0f, false, "", 0, 0f, 0, 0.25f, 0.05f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "InitSoldierUp", "", "", "", "MagicChargeYellow", 0f, "xiang");
            ...
            config[200009] = new BattleSkillConfig(200009, "炮车", "炮", "攻击目标发生爆炸", "职业", 1, 0.5f, 0, 0f, "leadShip", null, 20f, false, "", 2, 0f, 0, 0f, 0.6f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "HitArea", "throw", "", "", "MagicNovaYellow", 0f, "pao");
            ...
            config[200011] = new BattleSkillConfig(200011, "冲锋", "车", "移动时穿越敌人,降低目标防御", "职业", 1, 1f, 7, 0f, "leadShip", null, 0f, false, "", 0, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 301003, false, 3, "", 0, 0f, 0, 0f, 0f, "AttackRunCrossPlus", "", "LightningExplosionRed", "", "", 0f, "che");
            config[200012] = new BattleSkillConfig(200012, "声乐", "乐", "给与友军攻速祝福", "职业", 1, 1f, 3, 0f, "inte", null, 50f, false, "", 0, 0.45f, 0, 0f, 0f, 0f, 0, 0, "", "", 300005, false, 5, "", 0, 0f, 0, 0f, 0f, "HelpAidBuff", "sway", "", "", "MagicChargePink", 0f, "song");
            config[200013] = new BattleSkillConfig(200013, "治疗", "医", "给与友军治疗", "职业", 1, 1f, 3, 0f, "inte", null, 50f, false, "", 0, 0f, 0, 0.7f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "HelpAidHeal", "sway", "", "", "MagicBuffGreen", 0f, "heal");
            ...
            config[200015] = new BattleSkillConfig(200015, "戟阵", "戟", "攻击目标时伤害周边敌人", "职业", 1, 0.35f, 4, 0f, "leadShip", null, 25f, false, "", 2, 0f, 0, 0f, 0.6f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "HitAround", "throw", "", "", "SwordSlashMiniWhite", 0f, "ji");
            config[200016] = new BattleSkillConfig(200016, "战鼓", "鼓", "给与友军攻击力祝福", "职业", 1, 1f, 3, 0f, "inte", null, 50f, false, "", 0, 0.4f, 0, 0f, 0f, 0f, 0, 0, "", "", 300004, false, 5, "", 0, 0f, 0, 0f, 0f, "HelpAidBuff", "sway", "", "", "MagicChargeYellow", 0f, "gu");
            config[201002] = new BattleSkillConfig(201002, "铁骑", "铁", "自己和同行[马车]技能附带混乱效果", "攻击up", 1, 0f, 0, 0f, "leadShip", null, 0f, false, "", 0, 0f, 0, 0f, 0f, 0f, 0, 1, "铁", "马车", 301001, false, 2, "", 0, 0f, 0, 0f, 0f, "BuffTieqi", "", "", "", "", 0f, "tie");
            config[201003] = new BattleSkillConfig(201003, "奇袭", "奇", "自己和同行队友统帅技能造成的混乱时间增加50%", "攻击up", 1, 0f, 0, 0f, "leadShip", new string[]{"leadShip"}, 0f, false, "", 0, 0.5f, 0, 0f, 0f, 0f, 0, 1, "奇", "", 301001, true, 0, "", 0, 0f, 0, 0f, 0f, "ModifyBuffTime", "", "", "", "", 0f, "qi");
            ...
            config[201007] = new BattleSkillConfig(201007, "速射", "速", "自己和同行[弓弩]箭矢飞行速度提升", "攻击up", 1, 0f, 0, 0f, "leadShip", null, 0f, false, "", 0, 2.5f, 0, 0f, 0f, 0f, 0, 1, "速", "弓弩", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "ModifyShootSpeed", "", "", "", "", 0f, "su");
            config[201008] = new BattleSkillConfig(201008, "箭雨", "雨", "攻击时30%发出2只箭", "", 1, 0.3f, 4, 0f, "leadShip", null, 30f, false, "", 1, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackMultiArrow", "flipspin", "", "", "", 0f, "duo");
            config[201009] = new BattleSkillConfig(201009, "共杀", "共", "击中目标时触发2次弹射", "", 1, 0.35f, 5, 0f, "inte", null, 30f, false, "", 3, 0f, 0, 0f, 0.25f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackReboundArrow", "flipspin", "", "", "", 0f, "gong2");
            config[201010] = new BattleSkillConfig(201010, "旋风斩", "旋", "攻击时几率对附近敌人造成伤害", "技", 1, 0.4f, 5, 0f, "str", null, 25f, false, "", 5, 0f, 0, 0f, 0.8f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackSpinAttack", "spin", "SwordWhirlwindWhite", "", "", 0f, "meng");
            config[201011] = new BattleSkillConfig(201011, "落雷", "天", "攻击召唤出持续伤害的雷电阵", "术", 1, 0.3f, 10, 0f, "inte", null, 0f, false, "", 1, 0f, 0, 0f, 0f, 0.15f, 0, 0, "", "", 0, false, 0, "雷", 0, 25f, 3, 0.5f, 0f, "HitRegion", "spin", "", "SummonStorm", "", 5f, "tian");
            config[201012] = new BattleSkillConfig(201012, "火计", "火", "攻击时对目标放火", "术", 1, 0.3f, 5, 0f, "inte", null, 0f, false, "", 1, 0f, 0, 0f, 0f, 0.1f, 0, 0, "", "", 0, false, 0, "火", 1, 8f, 3, 1f, 0f, "HitWall", "throw", "", "SoftFireBigRed", "", 1.6f, "huo");
            config[201013] = new BattleSkillConfig(201013, "火墙", "炎", "攻击召唤出持续伤害的火墙", "术", 1, 0.3f, 8, 0f, "inte", null, 0f, false, "", 1, 0f, 0, 0f, 0f, 0.08f, 0, 0, "", "", 0, false, 0, "火", 5, 8f, 3, 1f, 0f, "HitWall", "spin", "", "SoftFireBigRed", "", 1.6f, "yan");
            config[201014] = new BattleSkillConfig(201014, "飞斧", "斧", "扔出飞斧攻击前方敌人", "技", 1, 1f, 6, 0f, "str", null, 45f, false, "", 4, 0f, 0, 0f, 0f, 0.4f, 0, 0, "", "", 0, false, 0, "武", 0, 9f, 2, 0f, 40f, "AidShockWave", "spin", "", "", "AxeExplosion", 3f, "fu3");
            config[201015] = new BattleSkillConfig(201015, "驰羽", "羽", "能够射出箭矢", "技", 1, 1f, 7, 0f, "leadShip", null, 42f, false, "", 0, 0f, 0, 0f, 0f, 0.75f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AidSuddenArrow", "sway", "", "", "BulletExplosionBlue", 3f, "yu");
            config[201016] = new BattleSkillConfig(201016, "惊雷", "雷", "召唤3个惊雷攻击前方敌人", "术", 1, 1f, 6, 0f, "inte", null, 60f, false, "", 4, 0f, 0, 0f, 0f, 0.25f, 0, 0, "", "", 0, false, 0, "雷", 0, 11f, 2, 0f, 40f, "AidShockWave", "spin", "", "", "NukeMissileFires", 4f, "lei");
            config[201017] = new BattleSkillConfig(201017, "鬼谋", "鬼", "攻击造成生命值比例伤害", "", 1, 0.25f, 2, 1f, "inte", null, 0f, false, "", 0, 0.2f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "DamageReal", "sway", "", "", "", 0f, "gui");
            config[201018] = new BattleSkillConfig(201018, "斩", "斩", "直接杀死低生命值单位", "", 1, 0f, 7, 0.3f, "str", null, 0f, false, "", 0, 1f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "DamageReal", "spin", "", "", "SwordHitRedCritical", 0f, "zhan");
            ...
            config[201020] = new BattleSkillConfig(201020, "埋伏", "伏", "被攻击时瞬移到远程攻击者附近", "", 1, 1f, 6, 0f, "leadShip", null, 30f, false, "", 0, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 301001, false, 1, "", 0, 0f, 0, 0f, 0f, "HitTeleport", "saw", "MagicNovaBlue", "", "", 0f, "fu");
            config[201021] = new BattleSkillConfig(201021, "火矢", "矢", "攻击时射出火箭", "技", 1, 0.35f, 3, 0f, "str", null, 0f, false, "", 1, 0f, 0, 0f, 0f, 0.12f, 0, 0, "", "", 0, false, 0, "火", 1, 8f, 3, 1f, 0f, "HitWall", "throw", "", "SoftFireBigRed", "", 1.6f, "shi3");
            ...
            config[202001] = new BattleSkillConfig(202001, "刺甲", "刺", "反弹50%近战伤害", "防御up", 1, 0.3f, 0, 0f, "str", new string[]{"str，leadShip"}, 20f, false, "", 0, 0.5f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "DefFeedback", "", "", "", "SwordHitBlue", 0f, "ci");
            config[202002] = new BattleSkillConfig(202002, "藤甲", "藤", "受非智力攻击时高几率发动70%减伤", "", 1, 0.5f, 0, 0f, "str", new string[]{"str，leadShip"}, 0f, false, "", 0, 0.7f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "DefPlantSkin", "", "", "", "", 0f, "teng");
            ...
            config[202005] = new BattleSkillConfig(202005, "护卫", "护", "给与友军护盾祝福", "", 1, 1f, 8, 0f, "str", null, 50f, false, "", 0, 0.18f, 0, 0f, 0f, 0f, 0, 0, "", "", 300001, false, 10, "", 0, 0f, 0, 0f, 0f, "HelpAidBuff", "sway", "", "", "MagicChargeYellow", 0f, "hu1");
            ...
            config[202009] = new BattleSkillConfig(202009, "冷静", "静", "降低同行智力类技能造成的负面状态时间", "防御up", 1, 0f, 0, 0f, "leadShip", new string[]{"inte"}, 0f, false, "", 0, 0.5f, 0, 0f, 0f, 0f, 0, 1, "境", "", 0, true, 0, "", 0, 0f, 0, 0f, 0f, "ModifyBeBuffTime", "", "", "", "", 0f, "jing3");
            config[202010] = new BattleSkillConfig(202010, "冷静小", "境", "降低智力类技能造成的负面状态时间", "防御up", 1, 0f, 0, 0f, "leadShip", new string[]{"inte"}, 0f, false, "", 0, 0.5f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, true, 0, "", 0, 0f, 0, 0f, 0f, "ModifyBeBuffTime", "", "", "", "", 0f, "jing4");
            ...
            config[203002] = new BattleSkillConfig(203002, "连锁", "锁", "锁定敌人目标,传递一半受到伤害", "术", 1, 0.5f, 3, 0f, "inte", null, 25f, false, "targetUnit", 1, 0f, 0, 0f, 0.5f, 0f, 0, 0, "", "", 301002, false, 8, "", 0, 0f, 0, 0f, 0f, "HitBuffArea", "throw", "", "", "MagicNovaYellow", 0f, "suo");
            ...
            config[203004] = new BattleSkillConfig(203004, "威震", "威", "攻击时混乱周围目标", "", 1, 0.2f, 5, 0f, "str", null, 20f, false, "castUnit", 3, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 301001, false, 1, "", 0, 0f, 0, 0f, 0f, "HitBuffArea", "spin", "", "", "MagicNovaYellow", 0f, "wei");
            ...
            config[203009] = new BattleSkillConfig(203009, "分兵", "分", "被攻击时产生一只有伤害部队", "", 1, 0.4f, 15, 0f, "leadShip", null, 15f, false, "", 0, 0f, 0, 0.5f, 0.5f, 0f, 4, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackedShadow", "sway", "MagicFieldGreen", "", "MagicFieldGreen", 0f, "fen2");
            config[203010] = new BattleSkillConfig(203010, "分兵小", "纷", "被攻击时产生一只无伤害部队", "", 1, 0.4f, 15, 0f, "leadShip", null, 15f, false, "", 0, 0f, 0, 0.4f, 0.01f, 0f, 4, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "AttackedShadow", "sway", "MagicFieldGreen", "", "MagicFieldGreen", 0f, "fen3");
            ...
            config[208004] = new BattleSkillConfig(208004, "蔓延", "延", "自己和同行[扇谋相]技能负面状态扩散", "智技up", 1, 0.5f, 3, 0f, "inte", new string[]{"inte"}, 30f, false, "", 2, 0f, 0, 0f, 0f, 0f, 0, 1, "筵", "扇谋相", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "BuffExpand", "", "", "", "", 0f, "yan2");
            config[208005] = new BattleSkillConfig(208005, "蔓延小", "筵", "技能负面状态概率扩散", "智技up", 1, 0.5f, 3, 0f, "inte", new string[]{"inte"}, 30f, false, "", 2, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "BuffExpand", "", "", "", "", 0f, "yan3");
            config[208006] = new BattleSkillConfig(208006, "同调", "调", "自己和同行[鼓乐医]技能正面状态扩散", "智技up", 1, 0.5f, 3, 0f, "inte", new string[]{"inte"}, 30f, false, "", 2, 0f, 0, 0f, 0f, 0f, 0, 1, "碉", "鼓乐医", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "BuffExpandPos", "", "", "", "", 0f, "diao");
            config[208007] = new BattleSkillConfig(208007, "同调小", "碉", "技能正面状态扩散", "智技up", 1, 0.5f, 3, 0f, "inte", new string[]{"inte"}, 30f, false, "", 2, 0f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "BuffExpandPos", "", "", "", "", 0f, "diao2");
            ...
            config[208009] = new BattleSkillConfig(208009, "曲扬", "曲", "正面祝福状态时间增加50%", "智技up", 1, 0f, 0, 0f, "inte", new string[]{"inte"}, 0f, false, "", 0, 0.5f, 0, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "ModifyBuffTime", "", "", "", "", 0f, "qu");
            config[209001] = new BattleSkillConfig(209001, "富甲", "商", "战斗开始时获得金币", "", 1, 0f, 0, 0f, "inte", null, 0f, false, "", 0, 0f, 5, 0.05f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "InitGold", "", "MagicChargeYellow", "", "", 0f, "gold");
            config[209002] = new BattleSkillConfig(209002, "国士", "国", "增加一个远程士兵并提升射程", "", 1, 0f, 0, 0f, "inte", null, 15f, false, "", 0, 0f, 0, 0.075f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "InitSoldierSummon", "", "", "", "MagicChargeGreen", 0f, "guo");
            config[209003] = new BattleSkillConfig(209003, "仁德", "仁", "给与我方前排士兵12%生命值护盾", "", 1, 0f, 0, 0f, "leadShip", null, 0f, false, "", 0, 0f, 0, 0.12f, 0f, 0f, 0, 0, "", "", 300001, false, 999, "", 0, 0f, 0, 0f, 0f, "InitSoldierShield", "", "", "", "", 0f, "ren");
            config[209004] = new BattleSkillConfig(209004, "激励", "励", "提升同列队友智力", "", 1, 0f, 0, 0f, "inte", null, 0f, false, "", 0, 0f, 0, 0.7f, 0f, 0f, 0, 2, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "HelpInitTeach", "", "", "", "MagicChargeYellow", 0f, "li");
            ...
            config[209006] = new BattleSkillConfig(209006, "制衡", "衡", "初始获得我方兵种数为3,4,5时,提升属性10,20,30", "", 1, 0f, 0, 0f, "inte", null, 0f, false, "", 0, 0f, 5, 0f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "InitAttrZhiheng", "", "MagicChargeYellow", "", "", 0f, "heng");
            config[209007] = new BattleSkillConfig(209007, "米道", "米", "战斗开始时获得粮食", "", 1, 0f, 0, 0f, "inte", null, 0f, false, "", 0, 0f, 10, 0.1f, 0f, 0f, 0, 0, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "InitFood", "", "MagicChargeYellow", "", "", 0f, "food");
            config[209008] = new BattleSkillConfig(209008, "奋进", "奋", "提升同列队友武力", "", 1, 0f, 0, 0f, "str", null, 0f, false, "", 0, 0f, 0, 0.7f, 0f, 0f, 0, 2, "", "", 0, false, 0, "", 0, 0f, 0, 0f, 0f, "HelpInitTeach", "", "", "", "MagicChargePink", 0f, "fen");
