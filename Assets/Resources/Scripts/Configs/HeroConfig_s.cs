...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[100002] = new HeroConfig(100002, "曹操", 155, 220, 98, 81, 91, 94, 96, 8, 8, 7, 6, 8, 497, false, 2, "许昌", "陈留", 100, "豪爽", new string[]{"雄才","狡诈"}, new string[]{"兵法","诗歌","美色"}, "曹魏奠基", new string[]{"夏侯惇","许褚","郭嘉"}, new string[]{"刘备","吕布","马腾"}, new string[]{"官渡之战","煮酒论英雄","割须弃袍"}, 1, new int[0], "识", "", "core", "SwordHitYellowCritical", "caocao");
            config[102001] = new HeroConfig(102001, "郭嘉", 170, 207, 72, 43, 98, 78, 82, 6, 5, 5, 5, 8, 402, false, 2, "宛", "许昌", 100, "豪爽", new string[]{"雄才","洞察"}, new string[]{"饮酒","清谈"}, "颍川谋士", new string[]{"曹操","荀彧"}, new string[]{"无"}, new string[]{"遗计定辽东","十胜十败论"}, 3, new int[0], "天", "", "inte", "LightningExplosionBlue", "guojia");
            config[102002] = new HeroConfig(102002, "夏侯惇", 155, 220, 91, 91, 57, 68, 80, 9, 9, 7, 7, 7, 426, false, 2, "许昌", "陈留", 100, "刚猛", new string[]{"果敢","忠义"}, new string[]{"舞剑","骑马"}, "曹氏宗室", new string[]{"曹操","夏侯渊"}, new string[]{"无"}, new string[]{"拔矢啖睛"}, 1, new int[0], "青", "", "atk", "SwordHitYellowCritical", "xiahoudun");
            config[102003] = new HeroConfig(102003, "荀彧", 163, 212, 67, 47, 95, 100, 93, 5, 4, 4, 4, 8, 427, false, 2, "许昌", "许昌", 95, "谦和", new string[]{"仁德","贤明"}, new string[]{"熏香","书法"}, "颍川谋士", new string[]{"曹操","荀攸"}, new string[]{"无"}, new string[]{"劝曹操迎天子"}, 3, new int[0], "国", "", "help", "FrostExplosionBlue", "xunyu");
            config[102004] = new HeroConfig(102004, "许褚", 169, 227, 65, 96, 36, 20, 59, 9, 7, 7, 7, 7, 313, false, 2, "许昌", "陈留", 99, "刚猛", new string[]{"忠义","果敢"}, new string[]{"舞剑"}, "曹魏宿将", new string[]{"曹操","曹仁"}, new string[]{"马超"}, new string[]{"裸衣斗马超"}, 1, new int[0], "斧", "", "atk", "SwordHitYellowCritical", "xuchu");
            config[102005] = new HeroConfig(102005, "夏侯渊", 155, 219, 90, 89, 54, 40, 80, 8, 9, 9, 7, 7, 393, false, 2, "小沛", "陈留", 100, "急躁", new string[]{"果敢","专注"}, new string[]{"骑马","射猎"}, "曹氏宗室", new string[]{"夏侯惇","曹操"}, new string[]{"无"}, new string[]{"定军山被斩（负面","不写）"}, 3, new int[0], "雨", "", "shoot", "BulletExplosionBlue", "xiahouyuan");
            config[102006] = new HeroConfig(102006, "典韦", 155, 197, 59, 95, 43, 38, 78, 10, 7, 7, 7, 7, 351, false, 2, "许昌", "陈留", 100, "刚猛", new string[]{"忠义","果敢"}, new string[]{"舞戟","饮酒"}, "曹魏宿将", new string[]{"曹操"}, new string[]{"无"}, new string[]{"宛城护主战死"}, 1, new int[0], "护", "", "def", "SwordHitYellowCritical", "dianwei");
            config[102007] = new HeroConfig(102007, "徐晃", 155, 227, 90, 91, 74, 68, 71, 9, 8, 8, 7, 7, 433, false, 2, "下邳", "洛阳", 95, "冷静", new string[]{"坚韧","清廉"}, new string[]{"兵法","读书"}, "曹魏五子良将", new string[]{"曹操","关羽"}, new string[]{"无"}, new string[]{"解樊城之围"}, 3, new int[0], "连", "", "shoot", "BulletExplosionBlue", "xuhuang");
            config[102008] = new HeroConfig(102008, "荀攸", 157, 214, 63, 53, 93, 91, 73, 5, 4, 5, 5, 7, 399, false, 2, "许昌", "许昌", 97, "隐忍", new string[]{"智识","思辨"}, new string[]{"围棋"}, "颍川谋士", new string[]{"荀彧","曹操"}, new string[]{"无"}, new string[]{"官渡献策"}, 3, new int[0], "百", "米", "inte", "FrostExplosionBlue", "xunyou");
            ...
            config[102010] = new HeroConfig(102010, "曹仁", 168, 223, 90, 86, 62, 46, 76, 8, 8, 7, 7, 7, 397, false, 2, "宛", "陈留", 100, "隐忍", new string[]{"坚韧","果敢"}, new string[]{"骑马"}, "曹氏宗室", new string[]{"曹操","夏侯惇"}, new string[]{"无"}, new string[]{"坚守樊城"}, 1, new int[0], "青", "", "atk", "SwordHitYellowCritical", "caoren");
            ...
            config[102019] = new HeroConfig(102019, "陈群", 165, 237, 65, 45, 74, 98, 73, 4, 3, 3, 3, 6, 374, false, 2, "许昌", "许昌", 93, "冷静", new string[]{"贤明","思辨"}, new string[]{"律法","书法"}, "颍川士族", new string[]{"曹丕","司马懿"}, new string[]{"无"}, new string[]{"创立九品中正制"}, 3, new int[0], "励", "米", "help", "FanExplosion", "chenqun");
            ...
            config[102023] = new HeroConfig(102023, "刘晔", 175, 234, 65, 49, 92, 75, 69, 5, 4, 5, 5, 8, 377, false, 2, "小沛", "寿春", 92, "冷静", new string[]{"智识","洞察"}, new string[]{"发明"}, "曹魏谋士", new string[]{"曹操","曹丕"}, new string[]{"无"}, new string[]{"献投石车破袁绍"}, 3, new int[0], "", "", "shoot", "GasShootFire", "liuye");
            ...
            config[102025] = new HeroConfig(102025, "曹彰", 189, 223, 82, 90, 37, 32, 71, 8, 9, 7, 7, 5, 348, false, 2, "小沛", "陈留", 96, "刚猛", new string[]{"果敢"}, new string[]{"射猎","武艺"}, "曹魏宗室", new string[]{"曹操"}, new string[]{"曹丕"}, new string[]{"北征乌桓"}, 1, new int[0], "青", "", "atk", "SwordHitYellowCritical", "caozhang");
            ...
            config[102029] = new HeroConfig(102029, "甄宓", 183, 221, 14, 3, 69, 64, 94, 1, 1, 1, 1, 4, 252, false, 2, "下邳", "北平", 91, "隐忍", new string[]{"仁德","贤明"}, new string[]{"读书","音律","女红"}, "曹魏后妃", new string[]{"曹丕"}, new string[]{"郭女王"}, new string[]{"洛神赋原型"}, 3, new int[0], "白", "", "help", "SoulExplosionOrange", "zhenshi");
            ...
            config[102035] = new HeroConfig(102035, "钟繇", 151, 230, 70, 37, 72, 91, 76, 5, 4, 4, 4, 6, 369, false, 2, "许昌", "许昌", 94, "谦和", new string[]{"贤明","勤勉"}, new string[]{"书法","读书"}, "颍川士族", new string[]{"曹操","曹丕"}, new string[]{"无"}, null, 3, new int[0], "米", "", "help", "SharpExplosionGreen", "zhongyao");
            ...
            config[100003] = new HeroConfig(100003, "孙策", 175, 200, 96, 93, 74, 75, 94, 8, 10, 7, 8, 7, 471, false, 3, "吴", "吴", 100, "豪爽", new string[]{"果敢","雄才"}, new string[]{"武艺","结交"}, "东吴奠基", new string[]{"周瑜","孙权"}, new string[]{"无"}, new string[]{"小霸王"}, 1, new int[0], "虎", "", "core", "SwordHitYellowCritical", "sunce");
            config[103001] = new HeroConfig(103001, "甘宁", 175, 215, 93, 94, 76, 18, 58, 8, 7, 8, 9, 7, 378, false, 3, "长沙", "江州", 97, "豪爽", new string[]{"果敢","忠义"}, new string[]{"舞剑","珍宝"}, "东吴大将", new string[]{"孙权","周泰"}, new string[]{"无"}, new string[]{"百骑劫魏营"}, 3, new int[0], "连", "", "shoot", "BulletExplosionBlue", "ganning");
            config[103002] = new HeroConfig(103002, "太史慈", 166, 206, 85, 93, 66, 58, 79, 8, 7, 9, 7, 7, 419, false, 3, "吴", "北海", 96, "刚猛", new string[]{"忠义","果敢"}, new string[]{"射箭","舞戟"}, "东吴大将", new string[]{"孙权","刘繇"}, new string[]{"无"}, new string[]{"北海救孔融"}, 3, new int[0], "雨", "", "shoot", "BulletExplosionBlue", "taishici");
            ...
            config[103004] = new HeroConfig(103004, "周泰", 170, 225, 76, 91, 48, 38, 60, 9, 7, 7, 8, 7, 351, false, 3, "长沙", "庐江", 97, "刚猛", new string[]{"忠义","果敢"}, new string[]{"舞刀","饮酒"}, "东吴元从", new string[]{"孙权","甘宁"}, new string[]{"无"}, new string[]{"濡须救孙权"}, 1, new int[0], "连", "", "atk", "SwordHitYellowCritical", "zhoutai");
            config[103005] = new HeroConfig(103005, "鲁肃", 172, 217, 80, 56, 92, 92, 89, 6, 5, 5, 7, 7, 439, false, 3, "柴桑", "寿春", 100, "谦和", new string[]{"仁德","雄才"}, new string[]{"读书","结交"}, "东吴谋士", new string[]{"周瑜","孙权"}, new string[]{"无"}, new string[]{"借荆州","单刀赴会"}, 3, new int[0], "商", "雷", "help", "SharpExplosionGreen", "lusu");
            config[103006] = new HeroConfig(103006, "周瑜", 175, 210, 96, 71, 96, 86, 93, 7, 7, 6, 9, 8, 479, false, 3, "柴桑", "庐江", 100, "豪爽", new string[]{"雄才","贤明"}, new string[]{"音律","饮酒","舞剑"}, "东吴都督", new string[]{"孙权","鲁肃"}, new string[]{"诸葛亮","刘备"}, new string[]{"火烧赤壁"}, 3, new int[0], "炎", "炽", "inte", "ExplosionFireballFire", "zhouyu");
            ...
            config[103008] = new HeroConfig(103008, "吕蒙", 178, 219, 91, 81, 84, 74, 82, 8, 7, 6, 8, 7, 448, false, 3, "柴桑", "汝南", 98, "果敢", new string[]{"果敢","勤勉"}, new string[]{"读书","兵法"}, "东吴都督", new string[]{"孙权","鲁肃"}, new string[]{"关羽"}, new string[]{"白衣渡江","孙权劝学"}, 1, new int[0], "学", "羽", "def", "SwordHitYellowCritical", "lvmeng");
            config[103009] = new HeroConfig(103009, "陆逊", 183, 245, 96, 69, 92, 87, 90, 7, 6, 6, 8, 8, 469, false, 3, "吴", "吴", 100, "冷静", new string[]{"雄才","思辨"}, new string[]{"读书","围棋"}, "东吴都督", new string[]{"孙权","周瑜"}, new string[]{"无"}, new string[]{"火烧连营"}, 3, new int[0], "炎", "", "inte", "GasExplosionFire", "luxun");
            config[103010] = new HeroConfig(103010, "张昭", 156, 236, 32, 2, 83, 98, 79, 3, 2, 2, 4, 6, 311, false, 3, "桂阳", "下邳", 100, "刚直", new string[]{"贤明","忠义"}, new string[]{"读书","书法"}, "东吴文臣", new string[]{"孙权"}, new string[]{"无"}, null, 3, new int[0], "", "", "help", "SharpExplosionGreen", "zhangzhao");
            config[103011] = new HeroConfig(103011, "诸葛瑾", 174, 241, 72, 34, 81, 90, 90, 5, 4, 4, 6, 7, 393, false, 3, "吴", "襄阳", 96, "谦和", new string[]{"仁德","思辨"}, new string[]{"读书","书法"}, "东吴谋士", new string[]{"孙权"}, new string[]{"无"}, null, 3, new int[0], "励", "", "help", "FanExplosion", "zhugejin");
            ...
            config[103014] = new HeroConfig(103014, "大乔", 175, 221, 17, 11, 72, 78, 92, 2, 1, 2, 3, 4, 280, false, 3, "吴", "庐江", 100, "隐忍", new string[]{"贤明"}, new string[]{"音律","女红"}, "东吴宗室", new string[]{"孙策"}, new string[]{"无"}, null, 3, new int[0], "碉", "陷", "help", "StormExplosion", "daqiao");
            config[103015] = new HeroConfig(103015, "小乔", 176, 223, 16, 12, 73, 77, 92, 2, 1, 3, 3, 4, 280, false, 3, "柴桑", "庐江", 100, "豪爽", new string[]{"贤明"}, new string[]{"音律","女红"}, "东吴宗室", new string[]{"周瑜"}, new string[]{"无"}, null, 3, new int[0], "曲", "陷", "help", "StormExplosion", "xiaoqiao");
            config[103016] = new HeroConfig(103016, "丁奉", 186, 271, 76, 95, 66, 51, 52, 8, 7, 7, 8, 7, 377, false, 3, "长沙", "庐江", 94, "刚猛", new string[]{"果敢"}, new string[]{"舞刀"}, "东吴后期", new string[]{"孙权","孙峻"}, new string[]{"无"}, new string[]{"雪中奋短兵"}, 3, new int[0], "", "", "shoot", "GasShootFire", "dingfeng");
            ...
            config[103023] = new HeroConfig(103023, "张纮", 153, 212, 23, 21, 83, 94, 79, 2, 1, 2, 4, 5, 314, false, 3, "会稽", "寿春", 100, "谦和", new string[]{"贤明","思辨"}, new string[]{"书法","读书"}, "东吴文臣", new string[]{"孙权"}, new string[]{"无"}, new string[]{"谏孙权迁都"}, 3, new int[0], "励", "", "help", "SharpExplosionGreen", "zhanghong");
            config[103024] = new HeroConfig(103024, "顾雍", 168, 243, 43, 18, 80, 92, 76, 4, 3, 3, 5, 6, 330, false, 3, "桂阳", "吴", 95, "冷静", new string[]{"贤明","仁德"}, new string[]{"饮酒","书法"}, "东吴文臣", new string[]{"孙权"}, new string[]{"无"}, null, 3, new int[0], "连", "", "inte", "FanExplosion", "guyong");
            ...
            config[199001] = new HeroConfig(199001, "孙权", 182, 252, 74, 65, 78, 87, 93, 7, 6, 5, 7, 6, 428, false, 3, "吴", "吴", 100, "隐忍", new string[]{"雄才","果敢"}, new string[]{"射猎","读书"}, "东吴奠基", new string[]{"周瑜","鲁肃","陆逊"}, new string[]{"曹操","刘备"}, new string[]{"赤壁之战","夷陵之战"}, 1, new int[0], "衡", "", "def", "SwordHitYellowCritical", "sunquan");
            config[100004] = new HeroConfig(100004, "袁绍", 154, 202, 86, 73, 70, 73, 90, 9, 7, 9, 5, 6, 412, false, 4, "邺", "汝南", 100, "刚愎", new string[]{"雄才"}, new string[]{"华服","珍宝"}, "河北霸主", new string[]{"审配","沮授"}, new string[]{"曹操","田丰"}, new string[]{"官渡之战"}, 1, new int[0], "", "", "core", "SwordHitYellowCritical", "yuanshao");
            config[104001] = new HeroConfig(104001, "张郃", 167, 231, 89, 90, 69, 56, 70, 9, 10, 7, 5, 7, 400, false, 4, "邺", "南皮", 95, "冷静", new string[]{"坚韧","果敢"}, new string[]{"兵法","武艺"}, "河北", new string[]{"司马懿"}, new string[]{"无"}, new string[]{"街亭破马谡"}, 1, new int[0], "分", "", "def", "SwordHitYellowCritical", "zhanghe");
            config[104002] = new HeroConfig(104002, "颜良", 165, 200, 78, 93, 42, 32, 53, 9, 10, 7, 5, 7, 318, false, 4, "南皮", "平原", 100, "刚愎", new string[]{"果敢"}, new string[]{"舞刀"}, "河北", new string[]{"袁绍"}, new string[]{"无"}, null, 1, new int[0], "破", "", "atk", "SwordHitYellowCritical", "yanliang");
            config[104003] = new HeroConfig(104003, "文丑", 163, 200, 79, 92, 48, 52, 68, 9, 9, 7, 5, 7, 359, false, 4, "晋阳", "平原", 100, "急躁", new string[]{"果敢"}, new string[]{"舞刀"}, "河北", new string[]{"袁绍"}, new string[]{"无"}, null, 1, new int[0], "刺", "", "def", "SwordHitYellowCritical", "wenchou");
            config[104004] = new HeroConfig(104004, "田丰", 170, 200, 72, 33, 93, 89, 64, 4, 3, 3, 3, 7, 367, false, 4, "晋阳", "南皮", 94, "刚直", new string[]{"忠义","智识"}, new string[]{"读书"}, "河北谋士", new string[]{"袁绍"}, new string[]{"逢纪"}, new string[]{"谏袁绍被下狱"}, 3, new int[0], "雷", "", "inte", "StormExplosion", "tianfeng");
            ...
            config[104008] = new HeroConfig(104008, "沮授", 169, 200, 78, 35, 90, 91, 74, 5, 3, 3, 3, 7, 386, false, 4, "邺", "南皮", 96, "忠义", new string[]{"忠义","智识"}, new string[]{"读书"}, "河北谋士", new string[]{"袁绍"}, new string[]{"郭图"}, new string[]{"拒降曹"}, 3, new int[0], "静", "", "inte", "StormExplosion", "jushou");
            ...
            config[105001] = new HeroConfig(105001, "张辽", 169, 222, 95, 92, 78, 56, 76, 9, 10, 7, 5, 7, 425, false, 5, "长安", "邺", 97, "冷静", new string[]{"忠义","果敢"}, new string[]{"武艺","兵法"}, "并州", new string[]{"关羽","曹操"}, new string[]{"无"}, new string[]{"威震逍遥津"}, 1, new int[0], "旋", "", "def", "SwordHitYellowCritical", "zhangliao");
            config[105002] = new HeroConfig(105002, "吕布", 156, 199, 91, 100, 26, 13, 40, 10, 10, 7, 5, 7, 297, false, 5, "洛阳", "晋阳", 85, "刚愎", new string[]{"果敢"}, new string[]{"武艺","赤兔马"}, "并州军阀", new string[]{"陈宫","张辽"}, new string[]{"刘备","曹操"}, new string[]{"辕门射戟"}, 1, new int[0], "魔", "羽", "atk", "SwordHitBlackRedCritical", "lvbu");
            config[105003] = new HeroConfig(105003, "华雄", 154, 191, 82, 90, 56, 40, 57, 9, 8, 7, 5, 7, 345, false, 5, "洛阳", "长安", 95, "刚猛", new string[]{"果敢"}, new string[]{"舞刀"}, "西凉", new string[]{"董卓"}, new string[]{"无"}, null, 1, new int[0], "纷", "", "atk", "SwordHitYellowCritical", "huaxiong");
            config[105004] = new HeroConfig(105004, "贾诩", 147, 223, 86, 50, 97, 85, 57, 5, 3, 3, 3, 7, 393, false, 5, "安定", "武威", 98, "隐忍", new string[]{"智识","洞察"}, new string[]{"谋略","养生"}, "西凉", new string[]{"张绣","曹操"}, new string[]{"无"}, new string[]{"宛城献策","离间马超韩遂"}, 3, new int[0], "延", "", "inte", "StormExplosion", "jiaxu");
            config[105005] = new HeroConfig(105005, "貂蝉", 169, 195, 27, 65, 81, 70, 95, 2, 2, 2, 1, 1, 346, false, 5, "洛阳", "晋阳", 92, "隐忍", new string[]{"忠义","果敢"}, new string[]{"音律","舞姿"}, "汉末", new string[]{"王允"}, new string[]{"董卓","吕布"}, new string[]{"连环计"}, 3, new int[0], "曲", "", "help", "StormExplosion", "diaochan");
            ...
            config[105008] = new HeroConfig(105008, "李儒", 164, 192, 63, 43, 91, 78, 38, 4, 3, 3, 2, 6, 329, false, 5, "洛阳", "长安", 94, "多疑", new string[]{"智识","狡诈"}, new string[]{"毒计"}, "西凉", new string[]{"董卓"}, new string[]{"无"}, new string[]{"献计迁都"}, 3, new int[0], "火", "", "inte", "ShadowExplosion", "liru");
            ...
            config[106001] = new HeroConfig(106001, "马超", 176, 222, 92, 97, 42, 25, 80, 9, 10, 7, 5, 7, 361, false, 6, "武威", "武威", 98, "急躁", new string[]{"果敢"}, new string[]{"武艺","骑射"}, "西凉", new string[]{"马岱","庞德"}, new string[]{"曹操","韩遂"}, new string[]{"渭水之战"}, 1, new int[0], "铁", "", "atk", "SwordHitWhiteCritical", "machao");
            ...
            config[106003] = new HeroConfig(106003, "庞德", 176, 219, 89, 94, 67, 43, 67, 9, 9, 7, 5, 7, 383, false, 6, "武威", "天水", 97, "刚猛", new string[]{"忠义","果敢"}, new string[]{"武艺"}, "西凉", new string[]{"马超"}, new string[]{"关羽"}, new string[]{"抬棺战关羽"}, 1, new int[0], "坚", "", "atk", "SwordHitYellowCritical", "pangde");
            ...
            config[107001] = new HeroConfig(107001, "魏延", 175, 234, 84, 91, 68, 49, 51, 9, 7, 7, 5, 7, 365, false, 7, "武陵", "襄阳", 87, "刚愎", new string[]{"果敢"}, new string[]{"武艺"}, "荆州", new string[]{"刘备","诸葛亮"}, new string[]{"杨仪"}, new string[]{"献长沙","汉中太守"}, 1, new int[0], "破", "乱", "atk", "SwordHitYellowCritical", "weiyan");
            config[107002] = new HeroConfig(107002, "黄忠", 145, 220, 88, 93, 64, 52, 75, 9, 7, 9, 5, 7, 399, false, 7, "武陵", "宛", 97, "刚猛", new string[]{"忠义","果敢"}, new string[]{"射箭","舞刀"}, "荆州", new string[]{"刘备","关羽"}, new string[]{"无"}, new string[]{"定军山斩夏侯渊"}, 3, new int[0], "矢", "速", "shoot", "BulletExplosionFire", "huangzhong");
            ...
            config[108004] = new HeroConfig(108004, "董允", 185, 246, 67, 65, 78, 94, 79, 3, 2, 2, 2, 5, 394, false, 8, "江州", "柴桑", 90, "谦和", new string[]{"贤明","勤勉"}, new string[]{"读书"}, "益州", new string[]{"诸葛亮","蒋琬"}, new string[]{"黄皓"}, null, 3, new int[0], "米", "", "inte", "FanExplosion", "dongyun");
            ...
            config[108007] = new HeroConfig(108007, "法正", 176, 220, 83, 52, 94, 79, 55, 5, 3, 3, 3, 7, 381, false, 8, "江州", "长安", 93, "多疑", new string[]{"雄才","果敢"}, new string[]{"谋略"}, "益州", new string[]{"刘备","诸葛亮"}, new string[]{"无"}, new string[]{"定军山献策"}, 3, new int[0], "溃", "", "inte", "GasExplosionFire", "fazheng");
            ...
            config[111009] = new HeroConfig(111009, "赵云", 168, 229, 91, 96, 76, 65, 81, 9, 9, 7, 5, 7, 436, false, 11, "北平", "晋阳", 90, "冷静", new string[]{"忠义","果敢"}, new string[]{"武艺","骑射"}, "幽州", new string[]{"刘备","关羽","张飞"}, new string[]{"无"}, new string[]{"长坂坡救阿斗"}, 1, new int[0], "镜", "羽", "def", "SwordHitWhiteCritical", "zhaoyun");
            ...
            config[120001] = new HeroConfig(120001, "邓艾", 197, 264, 94, 87, 89, 88, 75, 9, 9, 7, 5, 7, 460, false, 99, "", "新野", 0, "隐忍", new string[]{"坚韧","果敢"}, new string[]{"兵法","地理"}, "曹魏后期", new string[]{"司马懿"}, new string[]{"钟会"}, new string[]{"阴平渡险"}, 1, new int[0], "奇", "", "def", "SwordHitYellowCritical", "dengai");
            ...
            config[120004] = new HeroConfig(120004, "羊祜", 221, 278, 90, 64, 84, 90, 92, 7, 6, 5, 4, 6, 443, false, 99, "", "濮阳", 0, "谦和", new string[]{"仁德","贤明"}, new string[]{"读书","围棋"}, "西晋", new string[]{"陆抗"}, new string[]{"无"}, new string[]{"与陆抗交好"}, 1, new int[0], "敏", "", "atk", "SwordHitYellowCritical", "yangku");
            config[120005] = new HeroConfig(120005, "钟会", 225, 264, 82, 58, 92, 85, 65, 5, 3, 3, 3, 7, 401, false, 99, "", "下邳", 0, "多疑", new string[]{"雄才"}, new string[]{"书法","兵法"}, "曹魏后期", new string[]{"邓艾"}, new string[]{"邓艾","姜维"}, new string[]{"灭蜀后谋反"}, 3, new int[0], "缓", "", "inte", "StormExplosion", "zhonghui");
            ...
            config[199002] = new HeroConfig(199002, "诸葛亮", 181, 234, 98, 45, 100, 99, 92, 7, 5, 4, 3, 9, 462, false, 99, "", "襄阳", 0, "冷静", new string[]{"忠义","智识"}, new string[]{"读书","发明","音律"}, "蜀汉丞相", new string[]{"刘备","赵云","姜维"}, new string[]{"无"}, new string[]{"三顾茅庐","草船借箭","七擒孟获"}, 3, new int[0], "神", "空", "inte", "LightningExplosionYellow", "zhugeliang");
            config[199003] = new HeroConfig(199003, "姜维", 202, 264, 92, 89, 90, 66, 79, 9, 9, 7, 5, 7, 441, false, 99, "", "天水", 0, "冷静", new string[]{"忠义","果敢"}, new string[]{"武艺","兵法"}, "蜀汉后期", new string[]{"诸葛亮"}, new string[]{"无"}, new string[]{"九伐中原"}, 1, new int[0], "解", "", "def", "SwordHitYellowCritical", "jiangwei");
            ...
            config[199006] = new HeroConfig(199006, "庞统", 179, 214, 85, 47, 98, 86, 65, 5, 3, 3, 3, 7, 399, false, 99, "", "襄阳", 0, "豪爽", new string[]{"智识","果敢"}, new string[]{"清谈","饮酒"}, "蜀汉", new string[]{"刘备","诸葛亮"}, new string[]{"无"}, new string[]{"落凤坡"}, 3, new int[0], "锁", "火", "inte", "ExplosionFireballFire", "pangtong");
            ...
            config[199012] = new HeroConfig(199012, "司马懿", 179, 251, 98, 63, 98, 93, 87, 7, 5, 4, 4, 7, 465, false, 99, "", "庐江", 0, "隐忍", new string[]{"雄才","坚韧"}, new string[]{"兵法","权谋"}, "河内司马氏", new string[]{"曹丕"}, new string[]{"诸葛亮","曹爽"}, new string[]{"高平陵之变"}, 3, new int[0], "鬼", "", "inte", "ShadowExplosion", "simayi");
            ...
            config[199015] = new HeroConfig(199015, "文鸯", 238, 291, 76, 91, 64, 65, 68, 9, 8, 7, 5, 6, 389, false, 99, "", "永安", 0, "刚猛", new string[]{"果敢"}, new string[]{"武艺"}, "曹魏", new string[]{"无"}, new string[]{"无"}, new string[]{"单骑退雄兵"}, 3, new int[0], "速", "", "shoot", "BulletExplosionBlue", "wenyuan");
            ...
            config[199021] = new HeroConfig(199021, "孙坚", 155, 191, 93, 90, 77, 78, 92, 9, 9, 7, 5, 7, 458, false, 99, "", "吴", 0, "豪爽", new string[]{"果敢","忠义"}, new string[]{"武艺"}, "东吴奠基", new string[]{"程普","黄盖","韩当"}, new string[]{"刘表","黄祖"}, new string[]{"讨董卓"}, 1, new int[0], "旋", "", "atk", "SwordHitYellowCritical", "sunjian");
            config[199022] = new HeroConfig(199022, "诸葛恪", 203, 253, 72, 47, 90, 80, 57, 4, 3, 3, 4, 6, 364, false, 99, "", "北海", 0, "骄横", new string[]{"才思"}, new string[]{"围棋","辩论"}, "东吴后期", new string[]{"孙权"}, new string[]{"无"}, new string[]{"东兴大捷"}, 3, new int[0], "缓", "", "inte", "StormExplosion", "zhugege");
            ...
            config[199032] = new HeroConfig(199032, "马良", 187, 222, 68, 60, 93, 87, 86, 3, 2, 2, 2, 7, 405, false, 99, "", "襄阳", 0, "谦和", new string[]{"贤明","仁德"}, new string[]{"书法","读书"}, "蜀汉", new string[]{"诸葛亮"}, new string[]{"无"}, new string[]{"白眉最良"}, 3, new int[0], "静", "", "help", "SharpExplosionGreen", "maliang");
            config[199033] = new HeroConfig(199033, "蒋琬", 193, 246, 64, 52, 85, 97, 81, 4, 3, 2, 3, 5, 394, false, 99, "", "零陵", 0, "谦和", new string[]{"贤明","勤勉"}, new string[]{"治理"}, "蜀汉", new string[]{"诸葛亮"}, new string[]{"无"}, new string[]{"继任丞相"}, 3, new int[0], "", "", "help", "SharpExplosionGreen", "jiangwan");
            config[199034] = new HeroConfig(199034, "费祎", 185, 253, 68, 42, 83, 95, 83, 4, 3, 2, 3, 5, 386, false, 99, "", "江夏", 0, "谦和", new string[]{"贤明","能言"}, new string[]{"围棋"}, "蜀汉", new string[]{"诸葛亮","蒋琬"}, new string[]{"无"}, null, 3, new int[0], "励", "", "help", "SharpExplosionGreen", "feiyi");
            ...
            config[199038] = new HeroConfig(199038, "陆抗", 226, 274, 91, 63, 87, 88, 86, 8, 6, 5, 7, 6, 443, false, 99, "", "建业", 0, "冷静", new string[]{"忠义","贤明"}, new string[]{"兵法"}, "东吴后期", new string[]{"羊祜"}, new string[]{"无"}, new string[]{"西陵之战"}, 3, new int[0], "透", "", "shoot", "BulletExplosionBlue", "lukang");
