...
namespace CommonConfig
{
    public class HeroConfig
    {
        ...
        public static void Load()
        {
            ...
            config[111009] = new HeroConfig(111009, "赵云", 168, 229, 91, 96, 76, 65, 81, 9, 9, 7, 5, 7, 436, true, 11, "北平", "晋阳", 90, "冷静", new string[]{"忠义","果敢"}, new string[]{"武艺","骑射"}, "幽州", new string[]{"刘备","关羽","张飞"}, new string[]{"无"}, new string[]{"长坂坡救阿斗"}, 1, new int[0], "镜", "羽", "def", "SwordHitWhiteCritical", "zhaoyun");
